...
//    setButton(times);
    ...
    p[0].textContent = "Ойын бітті";
    p[1].textContent = "ұпайлар: " + score;
    p[2].textContent = "Үздік: " + JSON.parse(localStorage["high-score"]);

    if(best) {
        console.log('new high score');
        var newBest = elt('span', 'new');
        $(newBest).text('Жаңа рекорд');
        $(p[2]).append(newBest);
    }
