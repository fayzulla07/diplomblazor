...
document.getElementById("startReset").onclick = function() {
    ...
    // if we are not playing
        ...
        document.getElementById("instruction").innerHTML = "Дұрыс жауапты басыңыз.";
        // show countdown box
        var countLeft = 60;
        ...
        hide("gameOver");
        document.getElementById("startReset").innerHTML = "Қайта бастау";
        // start reducing time by 1s in loops
...
function gameOver(){
    ...
    document.getElementById("startReset").innerHTML = "Бастау";
    gameOn = false;
}
